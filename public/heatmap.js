  ...
  s(q.prototype, {
    ...
    init: function(a, b) {
      var c = a.options.legend.layout !== "vertical",
        e;
      e = l(this.defaultColorAxisOptions, {
        side: c ? 2 : 1,
        reversed: !c
      }, b, {
        opposite: !c,
    ...
    drawLegendSymbol: function(a,
      ...
      var c = a.padding,
        e = a.options,
        d = this.horiz,
        f = m(e.symbolWidth, d ? 200 : 12),
        g = m(e.symbolHeight, d ? 12 : 200),
        j = m(e.labelPadding, d ? 16 : 30),
        e = m(e.itemDistance, 10);
      this.setLegendColor();
    ...
    drawCrosshair: function(a, b) {
      var c = b && b.plotX,
        ...
        d, f = this.pos,
        g = this.len;
      if (b) d = this.toPixels(b[b.series.colorKey]), d < f ? d = f - 2 : d > f + g && (d = f + g + 2), b.plotX = d, b.plotY = this.len - d, n.prototype.drawCrosshair.call(this, a, b), b.plotX = c, b.plotY = e, this.cross && this.cross.attr({
    ...
    getPlotLinePath: function(a, b, c, e, d) {
      return typeof d === "number" ? this.horiz ? ["M", d - 4, this.top - 6, "L", d + 4, this.top - 6, d, this.top, "Z"] : ["M", this.left, d, "L", this.left - 6, d + 6, this.left -
        6, d - 6, "Z"
      ] : n.prototype.getPlotLinePath.call(this, a, b, c, e)
    },
    update: function(a, b) {
      var c = this.chart,
        e = c.legend;
  ...
  p.heatmap = w(p.scatter, l(r, {
    ...
    translate: function() {
      ...
      i(this.points, function(d) {
        var f = (a.colsize || 1) / 2,
          g = (a.rowsize || 1) / 2,
          h = e(Math.round(b.len - b.translate(d.x - f, 0, 1, 0, 1)), 0, b.len),
          f = e(Math.round(b.len - b.translate(d.x + f, 0, 1, 0, 1)), 0, b.len),
          i = e(Math.round(c.translate(d.y - g, 0, 1, 0, 1)), 0, c.len),
          g = e(Math.round(c.translate(d.y + g, 0, 1, 0, 1)), 0, c.len);
